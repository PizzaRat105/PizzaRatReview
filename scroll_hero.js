...
document.getElementById("upbtn1").addEventListener("click", function() {
    const animationDuration = 1500; // Animation duration in milliseconds
    const framesPerSecond = 60;
    const frameDuration = 1000 / framesPerSecond;
    ...
    function animateScroll(timestamp) {
        ...
        const elapsed = timestamp - startTime;
        const progress = Math.min(elapsed / animationDuration, 1);
        const scrollToValue = (1 - progress) * window.scrollY; // Scroll to top
...
document.getElementById("upbtn2").addEventListener("click", function() {
    const animationDuration = 1500; // Animation duration in milliseconds
    const framesPerSecond = 60;
    const frameDuration = 1000 / framesPerSecond;
