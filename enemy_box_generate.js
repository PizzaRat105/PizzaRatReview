...
const RuinsEnemySpriteData = [
    ...
    { id: "bone_captain", content: "Bone Captain", useBigSprite: true, useTallSprite:false,useMediumSprite:false, useMedTallSprite: false,useSmallSprite: false,hasApprentice: false, hasVeteran: true, hasChampion:true, hasDarkest:false, hasShortName: false, hasMediumName:true, hasLongName: false, hasVeryShortName: false,},     
...
const WealdEnemySpriteData = [
    ...
    { id: "rabid_gnasher", content: "Rabid Gnasher", useBigSprite: false,useTallSprite:false,useMediumSprite:true, useMedTallSprite: false,useSmallSprite: false, hasApprentice: true, hasVeteran: true, hasChampion:true, hasDarkest:false, hasShortName: false, hasMediumName:true, hasLongName: false, hasVeryShortName: false,},
    ...
    { id: "unclean_giant", content: "Unclean Giant", useBigSprite: true, useTallSprite:false,useMediumSprite:false, useMedTallSprite: false,useSmallSprite: false,hasApprentice: false, hasVeteran: true, hasChampion:true, hasDarkest:false, hasShortName: false, hasMediumName:true, hasLongName: false, hasVeryShortName: false,},     
...
const coveskills = [
    ...
    //Squiffy Ghast
        ...
        { 
            ...
            critRate: 'Cannot CRIT',
            damage: '0',
            effects: ' Stress +9 <br> Horror (140% Base) 5 stress/rd for 4 rds'
        },
...
{ 
    extrainfo:'Never Used if all 4 heroes are Virtued <br>',
...
{ 
    ...
    critRate: 'Cannot CRIT',
    damage: '1',
    effects: 'Horror (4 rds) 3 stress/rd <br> Debuff Target: <br> +15% Stress (until camp) (100% Base)',
},
...
{ 
    ...
    critRate: 'Cannot CRIT',
    damage: '1-2',
    effects: 'Horror (4 rds) 4 stress/rd <br> Debuff Target: <br> +15% Stress (until camp) (120% Base)',
},
...
{ 
    ...
    critRate: 'Cannot CRIT',
    damage: '1-3',
    effects: 'Horror (4 rds) 4 stress/rd <br> Debuff Target: <br> +15% Stress (until camp) (140% Base)',
},
...
{ 
    ...
    critRate: '6%',
    damage: '1',
    effects: 'Stun (100% Base) <br> Mark Target <br> Debuff Target: <br> -15% Blight Resist (3 rds) (100% Base) ',
},
...
{ 
    ...
    critRate: '12%',
    damage: '2',
    effects: 'Stun (120% Base) <br> Mark Target <br> Debuff Target: <br> -20% Blight Resist (3 rds) (120% Base) ',
},
...
{ 
    ...
    critRate: '14%',
    damage: '2',
    effects: 'Stun (140% Base) <br> Mark Target <br> Debuff Target: <br> -25% Blight Resist (3 rds) (140% Base) ',
},
...
//Ghoul
    ...
    { 
        ...
        critRate: 'Cannot Crit',
        damage: '0',
        effects: ' Horror (75% Chance) 3 stress/rd <br> Torch -10 <br> Disease (The Worries) (5% Chance)'
    },
...
function generateSkillDescription(skill) {
    ...
    if (skill.accuracy !== undefined && skill.critRate !== undefined && skill.damage !== undefined) {
        stats = `ACC : ${skill.accuracy} / CRIT : ${skill.critRate} / DMG : ${skill.damage} <br>`;
    }
...
const RuinsenemyStrategies = [
    {
        ...
        content: [
            "The Swine Chopper has decent resists &",
            "PROT with a backline disruption skill",
            "in Ball and Chain and a bleed skill in",
            "Butcher Cut that gains a heal received",
            "debuff on higher levels. This can be a",
            "massive threat when coupled with the",
            "many other threats in the Warrens.",
            "That being said, you are still better",
            "off prioritizing the bigger threats and",
            "using stuns to neutralize it if needed."
        ],
    },

    {
        ...
        content: [
            "The Swine Wretch was made to be",
            "a pain in the ass. While it itself",
            "does minimal HP damage, its Vomit",
            "skill has a 33% chance of inflicting",
            "a disease, which is bad enough, but",
            "it's fast and dodgey too, making it",
            "difficult to take care of before it",
            "can get an attack off."
        ],
    },

    {
        ...
        content: [
            "The Swine Drummer is a stress dealer",
            "with Marking capabilities which it",
            "uses to help the few mark-based",
            "damage dealers in the Warrens.",
            "Being a stress dealer, it is annoying",
            "but it doesn't pose any real threat",
            "especially from veteran onwards, ",
            "unless enemies that benefit from ",
            "its mark are present."
        ],
    },

    {
        ...
        content: [
            "The Swine Slasher has decent PROT",
            "which covers for its tiny hp pool.",
            "Its only skill has high CRIT and gains",
            "a disease & bleed resist debuff",
            "on higher levels, which synergizes",
            "with its swine brethren. The",
            "Slasher gains Stealth from veteran,",
            "making it harder to get rid of early."
        ],
    },

    {
        ...
        content: [
            "The Carrion Eater has high resists",
            "and isn't too threatening alone, but",
            "deals hefty damage to marked heroes.",
            "The blight its skill has makes this",
            "more of a threat since a hero brought",
            "down to death's door may die from it.",
            "From Veteran, they gain a small chance",
            "to inflict diseases as well.",
            "It is best to get rid of the enemy",
            "that can mark for them or kill them",
            "outright before they can do much."
        ],
    },

    {
        ...
        content: [
            "The Large Carrion Eater shares the",
            "high resists of its smaller cousins",
            "as well as their damage bonus vs",
            "marked heroes. They are able to",
            "mark & debuff heroes before hitting",
            "them with Tentacle Devour, which",
            "can easily bring a hero down to 0 HP.",
            "Thankfully it can be stunned reliably.",
            "Guards, self-mark PROT tanking or ",
            "Mark clear via Arbalest or Musketeer ",
...

   {
        ...
        content: [
            "The Swinetaur is a tank with high",
            "resists & PROT with a huge hp pool.",
            "Make sure to keep it at rank 1 by",
            "eliminating any enemies/corpses it",
            "could stand behind after using Trot",
            "Retreat, for it can use two very",
            "threatening skills from the back.",
            "If left as the last enemy, it is",
            "an easy enemy to stall against."
        ],
    },
...
const WealdenemyStrategies = [
...

   {
...

    {
        ...
        content: [
            "The Skiver has decent resists, good",
            "dodge, and decent hp with 9 speed.",
            "It packs a punch, with a powerful",
            "AoE with Blight & Debuffs and a",
            "high damage disruption skill.",
            "Focus it down quickly, and maybe",
            "try pulling it to rank 1 where it",
            "will be a non-issue... for 1 attack.",
            "Do mind that blindly trying to kill",
            "the Skiver will let the other threats",
            "show you they're no slouch either."
        ],
    },
];
...
function createEnemyStrategies() {
    ...
    RuinsenemyStrategies.forEach((strategy) => {
        ...
        strategy.content.forEach((itemText) => {
            div.innerHTML += itemText + '<br>';
        });
